...
public class ProductionOrderDeclarationServiceBusinessImpl
    extends ProductionOrderDeclarationServiceImpl {

  @Inject
  public ProductionOrderDeclarationServiceBusinessImpl(
  ...
  protected ProductionOrder createProductionOrder(Declaration declaration) throws AxelorException {
    ...
    ProductionOrder productionOrder = super.createProductionOrder(declaration);

    if (appProductionService.isApp("production")
        && appProductionService.getAppProduction().getManageBusinessProduction()) {
      productionOrder.setProject(declaration.getProject());
    }
