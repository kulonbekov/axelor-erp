...
public interface DeclarationCreateService {
   ...
   */
  default Declaration createDeclaration(
  ...
  Declaration createTemplate(Declaration context);

  Declaration createDeclaration(Declaration context, Currency wizardCurrency, PriceList wizardPriceList)
      throws AxelorException;

  void updateDeclarationLineList(Declaration declaration) throws AxelorException;
}
