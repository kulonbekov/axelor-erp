...
public interface DeclarationMergingService {
  ...
  interface DeclarationMergingResult {
  ...
  DeclarationMergingResult create();

  CommonFields getCommonFields(DeclarationMergingResult result);

  Checks getChecks(DeclarationMergingResult result);

  DeclarationMergingResult mergeDeclarations(List<Declaration> declarationsToMerge) throws AxelorException;

  DeclarationMergingResult mergeDeclarationsWithContext(
