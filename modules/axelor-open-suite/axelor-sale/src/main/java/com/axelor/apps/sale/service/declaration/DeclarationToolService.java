...
public class DeclarationToolService {
  ...
  public BigDecimal getAccountingExTaxTotal(BigDecimal exTaxTotal, Declaration declaration)
      throws AxelorException {

    return currencyService
        .getAmountCurrencyConvertedAtDate(
            declaration.getCurrency(),
            declaration.getClientPartner().getCurrency(),
            exTaxTotal,
