...
import com.axelor.apps.supplychain.db.repo.DeclarationLineSupplychainRepository;
import com.axelor.apps.supplychain.db.repo.DeclarationSupplychainRepository;
...
import com.axelor.apps.supplychain.service.MrpFilterDeclarationLineServiceImpl;
...
import com.axelor.apps.supplychain.service.MrpDeclarationCheckLateSaleServiceImpl;
import com.axelor.apps.supplychain.service.MrpService;
import com.axelor.apps.supplychain.service.MrpServiceImpl;
import com.axelor.apps.supplychain.service.OpportunityDeclarationSupplychainServiceImpl;
...
import com.axelor.apps.supplychain.service.DeclarationCheckAnalyticServiceImpl;
import com.axelor.apps.supplychain.service.DeclarationComputeServiceSupplychainImpl;
import com.axelor.apps.supplychain.service.DeclarationCreateServiceSupplychainImpl;
...
import com.axelor.apps.supplychain.service.DeclarationMergingServiceSupplyChainImpl;
import com.axelor.apps.supplychain.service.DeclarationMergingViewServiceSupplyChainImpl;
...
import com.axelor.apps.supplychain.service.DeclarationReservedQtyServiceImpl;
...
import com.axelor.apps.supplychain.service.DeclarationStockServiceImpl;
...
public class SupplychainModule extends AxelorModule {
  ...
  protected void configure() {
    ...
    bind(DeclarationServiceImpl.class).to(DeclarationServiceSupplychainImpl.class);
    bind(DeclarationCreateServiceImpl.class).to(DeclarationCreateServiceSupplychainImpl.class);
    bind(DeclarationComputeServiceImpl.class).to(DeclarationComputeServiceSupplychainImpl.class);
    bind(DeclarationWorkflowServiceImpl.class).to(DeclarationWorkflowServiceSupplychainImpl.class);
    bind(PurchaseOrderInvoiceService.class).to(PurchaseOrderInvoiceServiceImpl.class);
    bind(DeclarationInvoiceService.class).to(DeclarationInvoiceServiceImpl.class);
    bind(DeclarationPurchaseService.class).to(DeclarationPurchaseServiceImpl.class);
    bind(StockMoveInvoiceService.class).to(StockMoveInvoiceServiceImpl.class);
    bind(DeclarationManagementRepository.class).to(DeclarationSupplychainRepository.class);
    bind(StockMoveServiceImpl.class).to(StockMoveServiceSupplychainImpl.class);
    bind(DeclarationLineServiceImpl.class).to(DeclarationLineServiceSupplyChainImpl.class);
    ...
    bind(MrpFilterDeclarationLineService.class).to(MrpFilterDeclarationLineServiceImpl.class);
    bind(MrpLineTypeService.class).to(MrpLineTypeServiceImpl.class);
    bind(MrpDeclarationCheckLateSaleService.class).to(MrpDeclarationCheckLateSaleServiceImpl.class);
    ...
    bind(DeclarationStockService.class).to(DeclarationStockServiceImpl.class);
    ...
    bind(StockLocationLineServiceImpl.class).to(StockLocationLineServiceSupplychainImpl.class);
    bind(DeclarationLineServiceSupplyChain.class).to(DeclarationLineServiceSupplyChainImpl.class);
    ...
    bind(DeclarationReservedQtyService.class).to(DeclarationReservedQtyServiceImpl.class);
    ...
    bind(DeclarationLineSaleRepository.class).to(DeclarationLineSupplychainRepository.class);
    ...
    bind(DeclarationSupplychainService.class).to(DeclarationServiceSupplychainImpl.class);
    ...
    bind(InvoiceManagementRepository.class).to(InvoiceSupplychainRepository.class);
    bind(OpportunityDeclarationServiceImpl.class)
        .to(OpportunityDeclarationSupplychainServiceImpl.class);
    ...
    bind(DeclarationMergingViewServiceImpl.class)
        .to(DeclarationMergingViewServiceSupplyChainImpl.class);
    bind(DeclarationMergingServiceImpl.class).to(DeclarationMergingServiceSupplyChainImpl.class);
    ...
    bind(DeclarationCheckAnalyticService.class).to(DeclarationCheckAnalyticServiceImpl.class);
