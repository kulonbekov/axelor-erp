...
public interface DeclarationCheckAnalyticService {
   ...
   *
   * @param declaration a non null sale order
   * @throws AxelorException if one or more lines are missing an analytic distribution
   */
  void checkDeclarationLinesAnalyticDistribution(Declaration declaration) throws AxelorException;
}
