...
public interface DeclarationReservedQtyService {
   ...
   * @throws AxelorException if the sale order does not have a stock move.
   */
  void deallocateAll(Declaration declaration) throws AxelorException;
   ...
   * @throws AxelorException if the sale order does not have a stock move.
   */
  void reserveAll(Declaration declaration) throws AxelorException;
   ...
   * @throws AxelorException if the sale order does not have a stock move.
   */
  void cancelReservation(Declaration declaration) throws AxelorException;
}
